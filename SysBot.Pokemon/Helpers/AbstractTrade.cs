...
namespace SysBot.Pokemon.Helpers
{
    ...
    public abstract class AbstractTrade<T> where T : PKM, new()
    {
        ...
        {
            string pattern = @"(YT$)|(YT\w*$)|(Lab$)|(\.[a-zA-Z]{2,})|(\.\w*$|\.\w*\/)|(TV$)|(PKHeX)|(FB:)|(AuSLove)|(ShinyMart)|(Blainette)|(\ com)|(\ org)|(\ net)|(\ me)|(\ dev)|(\ co)|(\ gov)|(\ us)|(\ edu)|(\ io)|(\ info)|(\ biz)|(\ online)|(\ store)|(\ uk)|(\ it)|(\ app)|(\ blog)|(\ design)|(\ tech)|(\ eco)|(\ shop)|(\ xyz)|(FreeMons)|(ShinyPKM)|(2DOS3)|(PPorg)|(Tik\w*ok$)|(YouTube)|(IG:)|(TTV )|(Tools)|(JokersWrath)|(bot$)|(PKMGen)|(TheHighTable)|(Kevdog)|(Machamps)|(ARTICUNOS.UK)|(AstralMogTV)|(Eevee.vip)|(EeveeLove)|(Gengars.com)|(golurks.com)|(grumpigs.com)|(KiTBOT)|(Kuro.TV)|(Mathemath.TV)|(MGDiscord.co)|(Mitsuki.TV)|(MonForge.com)|(MRPKM)|(MRPKMGO)|(Oceanside)|(onlypkmn.com)|(Pkm-Team)|(PKMFANS)|(pkmlab)|(PokeFAST)|(Pokeflash)|(pokegen)|(pokegz)|(PokeLabs)|(pokevend)|(Psyducks.com)|(Puplip.net)|(rocketpkm)|(Shiny24)|(thtable)|(tiny.)|(bit.ly)|(VenuLair)|(VgeekZ)|(whythe)|(wreythe)|(zacian.net)|(Zertion)|(theWrey)|(PKM.gg)|(PKM.co)|(PKM.org)|(AstralMog)|(MGDiscord)|(MonForge)|(MRPKM)|(MRPKMGO)|(OnlyPKM)|(OnlyPKMN)|(PokeLabs)|(PokeFlash)|(PKMTeam)|(PKM-Team)|(PokeGZ)|(RocketPKM)|(SWOSH)|(VGeekZ)|(Zertion)|(PokeFast)|(.com)|(.org)|(.biz)|(.co)|(.gg)|(.dev)|(.us)|(.edu)|(.io)|(.me)|(.uk)|(.it)|(.blog)|(.gov)|(.online)|(.store)|(.uk)|($TTV)|(TTV$)|($YT)|(YT$)|($FB)|(Blaines)";
