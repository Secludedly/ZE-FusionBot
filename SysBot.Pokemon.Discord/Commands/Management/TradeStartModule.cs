...
#pragma warning restore RCS1158 // Static member in generic type should use a type parameter.
    ...
    private static void AddLogChannel(ISocketMessageChannel c, ulong cid)
    {
        async void Logger(PokeRoutineExecutorBase bot, PokeTradeDetail<T> detail)
        {
            ...
            string embedImageUrl = detail.IsMysteryEgg ? "https://raw.githubusercontent.com/Secludedly/ZE-FusionBot-Sprite-Images/main/mysteryegg1.png" : detail.Type switch
            {
